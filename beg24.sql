...
--
-- Host: localhost
-- Tempo de geração: 21/02/2017 às 00:12
...
INSERT INTO `cidades` (`cid`, `estado_id`, `cidade`, `uf`) VALUES
...
CREATE TABLE `empresas` (
  ...
  `fotos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `empresas` (`id`, `cid_id`, `esd_id`, `empresa`, `endereco`, `horarios`, `telefone`, `fax`, `email`, `descricao`, `facebook`, `twitter`, `google`, `website`, `mapa`, `fotos`) VALUES
(1, 827, 17, 'Nossa Rede TELECOM', 'Alto dos Funcionários, rua 4, 51', 'Seg - Sex: 07:00-17:00 Sab - Dom: Fechado', '17624235551', '17624235551', 'contato@nossarede.com.br', 'Nenhuma Descrição para a Empresa atual', 'https://fb.com/cerbfenix2', 'https://twitter.com/0xCah0s', 'https://google.plus.com/user1', 'http://nossarede.com.br/', 'Centro', '9f9ad712ab4e217a12f9ce8055e12044.png,966cc10fb8961cb7a138a539cb5a8688.png,6d53597238f9165bf5da17ba70985f04.png,42fd5d627f3908c5175b596ce100cc10.png'),
(2, 454, 14, 'Nova empresa', 'Rua Aldaberto, 15', 'seg - sex: 07:00 as 16:00, sab - dom: fechado', '00 0000-0000', '00 0000-0000', 'suporte@novaempresa.de', 'breve descrição sobre a minha nova empresa....', 'nenhum', 'nenhum', 'nenhum', 'http://novaempresa.de', 'Rua Adalberto, 15', '6c72cfd8efc090e5d294d12045aef7af.jpg,f54cacb4a053bd961f0567f650f1be9f.jpg,f015a6c201c142386a02424a74a1ff8b.jpg,ddf4b32026014d81c744dc075d4200cf.jpg,ea1d96379f6d65ce7a311d621afd6056.jpg'),
(3, 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', NULL);
...
CREATE TABLE `estados` (
  ...
  `cidades` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bandeira` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `estados` (`eid`, `estado`, `cidades`, `bandeira`, `region`, `uf`) VALUES
(1, 'Acre', '22', 'Acre.svg', 'Norte', 'AC'),
(2, 'Alagoas', '102', 'Alagoas.svg', 'Nordeste', 'AL'),
(3, 'Amapá', '16', 'Amapá.svg', 'Norte', 'AP'),
(4, 'Amazonas', '62', 'Amazonas.svg', 'Norte', 'AM'),
(5, 'Bahia', '417', 'Bahia.svg', 'Nordeste', 'BH'),
(6, 'Ceará', '184', 'Ceará.svg', 'Nordeste', 'CE'),
(7, 'Distrito Federal', '0', 'Distrito_Federal.svg', 'Centro-Oeste', 'DF'),
(8, 'Espírito Santo', '78', 'Espírito_Santo.svg', 'Sudeste', 'ES'),
(9, 'Goiás', '246', 'Goiás.svg', 'Centro-Oeste', 'GO'),
(10, 'Maranhão', '217', 'Maranhão.svg', 'Nordeste', 'MA'),
(11, 'Mato Grosso', '141', 'Mato_Grosso.svg', 'Centro-Oeste', 'MT'),
(12, 'Mato Grosso do Sul', '79', 'Mato_Grosso_do_Sul.svg', 'Centro-Oeste', 'MS'),
(13, 'Minas Gerais', '853', 'Minas_Gerais.svg', 'Sudeste', 'MG'),
(14, 'Pará', '144', 'Pará.svg', 'Norte', 'PA'),
(15, 'Paraíba', '223', 'Paraíba.svg', 'Nordeste', 'PB'),
(16, 'Paraná', '399', 'Paraná.svg', 'Sul', 'PR'),
(17, 'Pernambuco', '185', 'Pernambuco.svg', 'Nordeste', 'PE'),
(18, 'Piauí', '224', 'Piauí.svg', 'Nordeste', 'PI'),
(19, 'Rio de Janeiro', '92', 'Rio_de_Janeiro.svg', 'Sudeste', 'RJ'),
(20, 'Rio Grande do Norte', '167', 'Rio_Grande_do_Norte.svg', 'Nordeste', 'RN'),
(21, 'Rio Grande do Sul', '497', 'Rio_Grande_do_Sul.svg', 'Sul', 'RS'),
(22, 'Rondônia', '52', 'Rondônia.svg', 'Norte', 'RO'),
(23, 'Roraima', '15', 'Roraima.svg', 'Norte', 'RR'),
(24, 'Santa Catarina', '295', 'Santa_Catarina.svg', 'Sul', 'SC'),
(25, 'São Paulo', '645', 'São_Paulo.svg', 'Sudeste', 'SP'),
(26, 'Sergipe', '75', 'Sergipe.svg', 'Nordeste', 'SE'),
(27, 'Tocantins', '139', 'Tocantins.svg', 'Norte', 'TO');
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `forname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lastname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `login` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pwdrec` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pwdtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `upd` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `creat` int(15) NOT NULL,
  ...
  `ontime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `offtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
...
INSERT INTO `users` (`id`, `forname`, `lastname`, `login`, `email`, `password`, `pwdrec`, `pwdtime`, `upd`, `creat`, `userkey`, `type`, `status`, `active`, `ontime`, `offtime`) VALUES
(1, 'Sebastian', 'Kopp', 'skopp', 'sebastiankopp.design@gmail.com', 'b5ad5ac273a77f62b728f457952c09957747a418', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1486857129, 'e5ed6c32deceea2ab283b3002ae182040faf589b98fa46e68046b960040dccf8', 'user', '0', 'offline', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'Amanda', 'Bermanelly', 'amandinha', 'mlk_zika-do-cinga@hotmail.com', 'e43aa10aa2a27bfc03f83bbfea6dd1e19175dac3', '', '2017-02-12 00:03:41', '0000-00-00 00:00:00', 1486857528, '', 'user', '2', 'offline', '0000-00-00 00:00:00', '2017-02-12 00:03:41'),
(3, 'admin', 'istrador', 'admin', '5kullcod@mail.ru', 'd033e22ae348aeb5660fc2140aec35850c4da997', '', '2017-02-19 23:01:22', '0000-00-00 00:00:00', 1486857649, '', 'user', '1', 'online', '2017-02-19 23:01:22', '2017-02-19 22:42:47'),
(4, 'Vagner', 'moderador', 'vagner', 'Cah0s@mail.com', '5f99060f9f712d732ad52fcf0f19062bf2a2a6b4', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1486857874, '1098e2ede4ec4ccf69fd97934d1bf330c8a47f192c3e8253fd968cabd51e0de9', 'user', '0', 'offline', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Cah0s', 'M4sked Ph4ntom', 'Cah0s', 'Cah0s@protonmail.com', '26302d50f48eafc52fa7b3aecf12f46a4043281e', '', '2017-02-12 03:01:49', '0000-00-00 00:00:00', 1486867296, '', 'user', '1', 'offline', '2017-02-12 03:01:44', '2017-02-12 03:01:49'),
(6, 'André', 'Freitas', 'andre', 'trickster.clown@mail.ru', 'bc9800b9d52a24cce72a73dd528afed53f10e5fc', 'd9d05b492c681eeb1b08332858f6535d0a56e71d', '2017-02-19 03:40:28', '0000-00-00 00:00:00', 1487473537, '', 'user', '1', 'offline', '2017-02-19 03:30:39', '2017-02-19 03:40:28');
...
--
ALTER TABLE `cidades`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5566;
--
...
--
ALTER TABLE `cidades`
  ADD CONSTRAINT `cidades_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`eid`);
